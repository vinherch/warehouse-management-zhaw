...
function CurrencyNew() {
  // /* useContext */
  // /* Call function from context to add new location. */
  const { addLocation, location, isExistingLocationCombination, setIsExistingLocationCombination } = useContext(LocationsContext);
  ...
  return (
    <div>
      <div className="create-edit-container">
        <h5 className="edit-title">Lokation erstellen</h5>
        <form>
          <div>
          ...
          <button
            ...
            onClick={(e) => {
              ...
              if (!isDisabled && !isExistingLocationCombination) {
                addLocation({ aisle: currentAisle, shelf: currentShelf, tray: currentTray });
              }
            }}
          >
            <FaCheck color="green" />
